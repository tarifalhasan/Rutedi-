...
const DynamicComponentWithNoSSR = dynamic(() => import('./Form'), {
  ssr: false,
});
...
const Contact = () => {
  return (
    <Container>
      <div className=" bg-[#F6F6F6] overflow-hidden py-12 w-full  flex gap-10  flex-col lg:flex-row ">
        <div className=" basis-[40%]">
          ...
          <div className=" py-6">
            <div className=" flex items-center gap-4">
              ...
              <span className=" text-2xl text-slate-900">+123 456 789 789</span>
            </div>
          </div>
          <div>
            <svg
